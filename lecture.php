    ...
    <div class="col-lg-10 mx-auto">
        ...
        <div class="card shadow-sm mb-4 border-0">
            <div class="card-header bg-dark text-white py-2 d-flex justify-content-between align-items-center">
                ...
                <button class="btn btn-sm btn-outline-light" type="button" aria-label="Toggle email configuration" data-bs-toggle="collapse" data-bs-target="#emailConfigBody"><i class="bi bi-chevron-down"></i></button>
            </div>
                    ...
                    <div class="row g-2 align-items-end">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group input-group-sm">
                                ...
                                <button class="btn btn-outline-secondary" type="button" aria-label="Toggle password visibility" onclick="togglePasswordVisibility()"><i class="bi bi-eye" id="pwd-eye-icon"></i></button>
                            </div>
                        </div>
                        <div class="col-md-2">
