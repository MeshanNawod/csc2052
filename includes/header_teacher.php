<?php
/**
 * Teacher Header — Sentinel Swarm AMS v3
 * Role-isolated navigation for teacher pages only.
...
<div class="floating-navbar-wrapper">
    <nav class="navbar navbar-expand-lg premium-navbar">
        <div class="container-fluid px-3">
            <a class="navbar-brand mb-0 h1 d-flex align-items-center" href="teacher_dashboard.php">
            ...
            <div class="collapse navbar-collapse" id="navBar">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                    <li class="nav-item"><a class="nav-link nav-link-premium <?php echo $page=='teacher_dashboard.php'?'active':''; ?>" href="teacher_dashboard.php"><i class="bi bi-display me-1"></i>Dashboard</a></li>
                </ul>
                <div class="d-flex align-items-center gap-3">
                    <span class="text-muted small"><i class="bi bi-person-circle me-1"></i><?php echo htmlspecialchars($_SESSION['full_name']??'Teacher'); ?></span>
