            ...
            <div class="collapse navbar-collapse" id="navBar">
                ...
                <div class="d-flex flex-column flex-lg-row align-items-lg-center gap-3 mt-3 mt-lg-0">
                    <div class="input-group node-ip-group">
                        ...
                        <input type="text" id="esp-ip" class="node-ip-input" placeholder="Node IP" title="Hardware Node IP Address">
                    </div>
                    ...
                    <a href="logout.php" class="btn btn-sm btn-danger btn-exit-nav px-3 py-2 fw-bold text-uppercase shadow-sm" title="End Session">Exit</a>
                </div>
            </div>
        </div>
    </nav>
