                        ...
                        <div class="row">
                                    ...
                                    <ul id="course-list" class="list-group list-group-flush small">
                                        <?php if (count($courses) > 0): ?>
                                            ...
                                            <li class="list-group-item d-flex justify-content-between align-items-center py-1">
                                                ...
                                                <button aria-label="Delete Course" class="btn btn-xs btn-outline-danger py-0 px-1" onclick="deleteCourse('<?php echo htmlspecialchars($c['course_code']); ?>')"><i class="bi bi-x-lg"></i></button>
                                            </li>
                                            <?php endforeach; ?>
                                        <?php else: ?>
                            ...
                            <div class="col-md-7 ps-md-4">
                                ...
                                <div class="row g-2 mb-2">
                                    ...
                                    <div class="col-2">
                                        <button aria-label="Enroll Student in Course" class="btn btn-success btn-sm w-100 fw-semibold" onclick="enrollStudentCourse()"><i class="bi bi-check-lg"></i></button>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-md-6 border-end pe-md-4">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <button aria-label="Auto Find Latest RFID Scan" class="btn btn-outline-info fw-semibold px-2" onclick="autoFindRfid('enroll-rfid')" title="Auto Find Latest Scan"><i class="bi bi-search"></i></button>
                        ...
                        <div class="input-group mb-2">
                            ...
                            <button aria-label="Auto Find Latest Face Scan" class="btn btn-outline-warning fw-semibold px-2" onclick="autoFindFace('enroll-face')" title="Auto Find Latest Scan"><i class="bi bi-search"></i></button>
...
<?php foreach ($course_data as $cc => $cd): ?>data-course-<?php echo htmlspecialchars($cc); ?>="<?php echo $cd['pct']; ?>|<?php echo $cd['days']; ?>/<?php echo $cd['total']; ?>"<?php endforeach; ?>>0%</span>
                                    ...
                                    <td class="text-end pe-3">
                                        <div class="btn-group shadow-sm">
                                            <button aria-label="Edit Student Details" onclick="editStudentMap('<?php echo htmlspecialchars($st['student_no'], ENT_QUOTES); ?>','<?php echo htmlspecialchars($st['student_name'], ENT_QUOTES); ?>','<?php echo htmlspecialchars($st['fingerprint_id'], ENT_QUOTES); ?>','<?php echo htmlspecialchars($st['rfid_uid'], ENT_QUOTES); ?>','<?php echo htmlspecialchars($st['face_id'], ENT_QUOTES); ?>')" class="btn btn-sm btn-light border text-info" title="Edit Student Details"><i class="bi bi-pencil-square"></i></button>
                                            <button aria-label="Push Finger to ESP" onclick="pushTemplateToDevice('<?php echo htmlspecialchars($st['student_no'], ENT_QUOTES); ?>',<?php echo ($st['fingerprint_id'] ? (int)$st['fingerprint_id'] : 0); ?>)" class="btn btn-sm btn-light border text-primary" title="Push Finger to ESP" <?php echo empty($st['fingerprint_id']) ? 'disabled' : ''; ?>><i class="bi bi-cloud-arrow-up"></i></button>
                                            ...
                                            <button aria-label="Delete Match" onclick="deleteStudentMap('<?php echo htmlspecialchars($st['student_no'], ENT_QUOTES); ?>')" class="btn btn-sm btn-light border text-danger" title="Delete Match"><i class="bi bi-trash"></i></button>
                                        </div>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                ...
                <div class="row">
                    <div class="col-md-6 border-end pe-md-4">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <button aria-label="Auto Find Latest Admin RFID Scan" class="btn btn-outline-danger fw-semibold px-2" onclick="autoFindRfid('enroll-admin-rfid')" title="Auto Find Latest Scan"><i class="bi bi-search"></i></button>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <button aria-label="Auto Find Latest Admin Face Scan" class="btn btn-outline-danger fw-semibold px-2" onclick="autoFindFace('enroll-admin-face')" title="Auto Find Latest Scan"><i class="bi bi-search"></i></button>
                ...
                for (let d = 1; d <= 6; d++) {
                    ...
                    if (s) {
                        ...
                        html += '<td class="' + dayColors[d] + ' align-middle" style="vertical-align:middle;">' +
                            ...
                            '<div class="mt-1">' +
                            '<button aria-label="Delete Schedule" class="btn btn-xs btn-outline-danger py-0 px-1" onclick="deleteSchedule(' + s.id + ')" title="Delete"><i class="bi bi-x"></i></button>' +
                            '</div>' +
                            '</td>';
                    } else {
    ...
    courses.forEach(course => {
        ...
        course.slots.forEach(slot => {
            html += `<tr>
                ...
                <td>
                    <button aria-label="Delete Time Slot" class="btn btn-xs btn-outline-danger py-0 px-2" onclick="deleteSchedule(${slot.id})" title="Delete slot">
