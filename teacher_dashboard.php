    ...
    <div class="start-hero p-4 d-inline-block" style="min-width: 500px; max-width: 700px; width: 100%;">
        ...
        <div class="row g-2 align-items-center justify-content-center">
            ...
            <div class="col-sm-3 d-flex align-items-end gap-1">
                ...
                <button class="btn btn-danger fw-bold py-2 px-3" id="btn-end" aria-label="End lecture" onclick="endLecture()" style="display:none;"><i class="bi bi-stop-fill"></i></button>
            </div>
        </div>
